...
C_SRCS += \
../01-Source/02-HAL/01-Button/source/Button.c 

OBJS += \
./01-Source/02-HAL/01-Button/source/Button.o 

C_DEPS += \
./01-Source/02-HAL/01-Button/source/Button.d 


# Each subdirectory must supply rules for building sources it contributes
01-Source/02-HAL/01-Button/source/%.o: ../01-Source/02-HAL/01-Button/source/%.c
	@echo 'Building file: $<'
